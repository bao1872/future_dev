...
def build_teacher(symbol: str, verbose: bool = True):
    ...
    outdir = write_oracle_artifact(res, TEACHER_DIR, oracle_source_sha=BASE_SHA)
        ...
        rows.append(
            {
                ...
                "builder_source_git_sha": BASE_SHA,
                "teacher_contract_id": tmeta.get("teacher_contract_id"),
